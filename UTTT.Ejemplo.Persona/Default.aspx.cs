    ...
    public partial class _Default : System.Web.UI.Page
    {
        ...
        private void setGridView()
        {
            ...
            catch (Exception _e)
            {
                ...
                mailMessage.From = new MailAddress("19300616@uttt.edu.mx");
                mailMessage.To.Add(new MailAddress("edel.meza@uttt.edu.mx"));
                mailMessage.Subject = "Mensaje";
                mailMessage.IsBodyHtml = true;
                mailMessage.Body = "La Exception es :" + _e.ToString();
                smtpClient.Port = 587;
                smtpClient.Host = "smtp.gmail.com";
                smtpClient.EnableSsl = true;
                smtpClient.UseDefaultCredentials = false;
                smtpClient.Credentials = new NetworkCredential("19300616@uttt.edu.mx", "MLR6230M");
